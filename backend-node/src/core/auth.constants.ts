...
export const DEFAULT_LOGIN_RATE_LIMIT_WINDOW_MS = 15 * 60 * 1000;
export const DEFAULT_LOGIN_RATE_LIMIT_MAX_PER_IP = 30;
export const DEFAULT_LOGIN_RATE_LIMIT_MAX_PER_USERNAME = 20;
