...
export const DEFAULT_PERMISSIONS: readonly PermissionSeed[] = [
  ...
  perm('reservations.view', 'View reservations', 'View reservation documents'),
  perm('reservations.create', 'Create reservations', 'Create and confirm reservations'),
  perm('reservations.checkout', 'Checkout reservations', 'Convert reservation to rental'),
  perm('reservations.cancel', 'Cancel reservations', 'Cancel draft or confirmed reservations'),
  perm('reservations.expire', 'Expire reservations', 'Mark reservations expired'),
  ...
  perm('rentals.view', 'View rentals', 'View rental workflow documents'),
  perm('rentals.create', 'Create rentals', 'Create draft rentals'),
  perm('rentals.checkout', 'Checkout rentals', 'Checkout draft rentals and bind inventory'),
  perm('rentals.return', 'Return rentals', 'Mark rental return pending'),
  perm('rentals.cancel', 'Cancel rentals', 'Cancel draft or outbound rentals'),
  perm('finance.view', 'View finance', 'View financial accounts, transactions, payments'),
  perm('finance.payment', 'Register payments', 'Register payments against financial accounts'),
  perm('finance.adjustment', 'Finance adjustments', 'Create financial adjustments (foundation)'),
  perm('finance.settlement.view', 'View settlements', 'View rental settlements'),
  perm('finance.settlement.manage', 'Manage settlements', 'Apply payments, close, cancel settlements'),
  ...
  perm('sales.view', 'عرض المبيعات', 'عرض مستندات البيع'),
  perm('sales.create', 'إنشاء بيع', 'إنشاء مستند بيع'),
  perm('sales.complete', 'إكمال بيع', 'تأكيد وإكمال البيع'),
  perm('sales.cancel', 'إلغاء بيع', 'إلغاء مستند بيع'),
  perm('sales.payment', 'دفع بيع', 'تسجيل دفعة على بيع'),
  ...
  perm('availability.view', 'عرض التوفر', 'عرض توفر الفساتين عبر التواريخ'),
