---
name: shape
description: Shape new features and screens before any code is written. Use when starting a new UI feature, screen, workflow, or component that is not yet well understood. Runs a discovery interview and returns a confirmed design brief (behavior, states, edge cases) without producing code.
---
