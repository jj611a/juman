---
name: audit
description: Run a systematic technical UI quality audit (accessibility, performance, theming, responsive, integrity) and generate a comprehensive report without fixing issues. Use to assess the current state of a codebase or screen before a refactor, or to produce a verifiable findings list for other agents or commands to act on.
---
