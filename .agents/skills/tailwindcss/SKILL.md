...
# Tailwind CSS ΓÇö Utility-first Styling Skill

## When to use
- Rapid UI building with consistent spacing/typography scales
- Design systems where composition beats bespoke CSS
- Component-driven apps (React/Vue/Svelte), marketing pages, prototypes ΓåÆ production
...
- Build pipeline:
  - Tailwind scans ΓÇ£contentΓÇ¥ files for class names and generates CSS (zero-runtime)
