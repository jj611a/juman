"""Fixtures for Categories module tests."""
...
from app.modules.inventory.models import BarcodeCounter, Dress  # noqa: F401
...
async def admin_client(
    ...
    _, token = await mint_admin_bearer(db_session, username="categories_admin")
