"""Fixtures for Returns module tests."""
...
async def active_rental(
    ...
    return await rental_service.create(
...
async def admin_client(
    ...
    _, token = await mint_admin_bearer(db_session, username="ret_admin")
