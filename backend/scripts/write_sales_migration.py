"""Write sales Alembic migration (UTF-8 safe)."""

from __future__ import annotations

from pathlib import Path

MIGRATION = Path(__file__).resolve().parents[1] / "alembic" / "versions" / "20260728_0027_sales.py"

CONTENT = '''"""Create sales tables; seed SAL settings + sale permissions.
...
SALE_NUMBER_SETTINGS: tuple[dict[str, object], ...] = (
    {
        ...
        "value_type": "string",
        "category": "sales",
        "description": "\\u0628\\u0627\\u062f\\u0626\\u0629 \\u0631\\u0642\\u0645 \\u0627\\u0644\\u0628\\u064a\\u0639",
        "is_editable": True,
    },
    {
        ...
        "value_type": "string",
        "category": "sales",
        "description": "\\u0641\\u0627\\u0635\\u0644 \\u0631\\u0642\\u0645 \\u0627\\u0644\\u0628\\u064a\\u0639 (\\u0641\\u0627\\u0631\\u063a \\u0623\\u0648 - \\u0623\\u0648 _)",
        "is_editable": True,
    },
    {
        ...
        "value_type": "integer",
        "category": "sales",
        "description": "\\u0639\\u062f\\u062f \\u0623\\u0631\\u0642\\u0627\\u0645 \\u062a\\u0633\\u0644\\u0633\\u0644 \\u0631\\u0642\\u0645 \\u0627\\u0644\\u0628\\u064a\\u0639",
        "is_editable": True,
    },
)

SALE_PERMISSIONS: tuple[dict[str, str], ...] = (
    {
        "key": "sale.view",
        "display_name": "\\u0639\\u0631\\u0636 \\u0627\\u0644\\u0645\\u0628\\u064a\\u0639\\u0627\\u062a",
        "description": "\\u0639\\u0631\\u0636 \\u0641\\u0648\\u0627\\u062a\\u064a\\u0631 \\u0627\\u0644\\u0628\\u064a\\u0639",
        "module": "sale",
    },
    {
        "key": "sale.create",
        "display_name": "\\u0625\\u0646\\u0634\\u0627\\u0621 \\u0628\\u064a\\u0639",
        "description": "\\u0625\\u0646\\u0634\\u0627\\u0621 \\u0641\\u0627\\u062a\\u0648\\u0631\\u0629 \\u0628\\u064a\\u0639",
        "module": "sale",
    },
    {
        "key": "sale.update",
        "display_name": "\\u062a\\u0639\\u062f\\u064a\\u0644 \\u0628\\u064a\\u0639",
        "description": "\\u062a\\u0639\\u062f\\u064a\\u0644 \\u0641\\u0627\\u062a\\u0648\\u0631\\u0629 \\u0628\\u064a\\u0639",
        "module": "sale",
    },
    {
        "key": "sale.cancel",
        "display_name": "\\u0625\\u0644\\u063a\\u0627\\u0621 \\u0628\\u064a\\u0639",
        "description": "\\u0625\\u0644\\u063a\\u0627\\u0621 \\u0641\\u0627\\u062a\\u0648\\u0631\\u0629 \\u0628\\u064a\\u0639",
        "module": "sale",
    },
)

CASHIER_SALE_KEYS: tuple[str, ...] = (
    "sale.view",
    "sale.create",
)
...
def upgrade() -> None:
    ...
    for perm in SALE_PERMISSIONS:
        ...
        if perm["key"] in CASHIER_SALE_KEYS:
            conn.execute(
                sa.text(
                    """
                    INSERT INTO role_permissions (
...
if __name__ == "__main__":
    MIGRATION.write_text(CONTENT, encoding="utf-8", newline="\n")
