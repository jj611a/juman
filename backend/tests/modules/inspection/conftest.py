"""Fixtures for Inspection module tests."""
...
async def pending_return(
    ...
    return await return_service.create(rental_id=rental.id)
...
async def admin_client(
    ...
    _, token = await mint_admin_bearer(db_session, username="insp_admin")
