"""Fixtures for Customers module tests."""
...
from app.modules.inventory.models import BarcodeCounter  # noqa: F401
...
async def admin_client(
    ...
    _, token = await mint_admin_bearer(db_session, username="customers_admin")
