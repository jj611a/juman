"""Fixtures for Identity module tests."""
...
async def api_client(db_session: AsyncSession) -> AsyncGenerator[AsyncClient]:
    ...
    from app.modules.identity.dependencies import get_session_service, get_user_service
...
async def admin_client(
    ...
    """Authenticated Admin client for Identity API tests."""
    from tests.helpers.auth import bearer_headers, mint_admin_bearer

    _, token = await mint_admin_bearer(db_session, username="identity_admin")
