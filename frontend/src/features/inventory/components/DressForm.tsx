...
import { DRESS_COLOUR_LABELS, DRESS_COLOURS, DRESS_SIZES } from '../statusMap'
    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {(
            [
              ['purchase_price', 'سعر الشراء (فلس)'],
              ['default_daily_rental_price', 'إيجار يومي (فلس)'],
              ['default_sale_price', 'سعر البيع (فلس)']
            ] as const
          ).map(([name, label]) => (
            <FormField
              key={name}
